...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'spot_membership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('spot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tag.List'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'spot', ['Membership'])


    def backwards(self, orm):
        # Deleting model 'Membership'
        db.delete_table(u'spot_membership')
    ...
    models = {
        ...
        u'spot.membership': {
            ...
            'spot': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tag.List']"}),
