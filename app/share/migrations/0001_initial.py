...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Waaave'
        db.create_table(u'share_waaave', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='waaave_user', to=orm['auth.User'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['_index.Ids'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'share', ['Waaave'])

        # Adding model 'Follow'
        db.create_table(u'share_follow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('follower', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follow_follower', to=orm['auth.User'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'share', ['Follow'])


    def backwards(self, orm):
        # Deleting model 'Waaave'
        db.delete_table(u'share_waaave')

        # Deleting model 'Follow'
        db.delete_table(u'share_follow')
