...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index(u'share_waaave', ['is_active'])

        # Adding index on 'Follow', fields ['is_active']
        db.create_index(u'share_follow', ['is_active'])


    def backwards(self, orm):
        # Removing index on 'Follow', fields ['is_active']
        db.delete_index(u'share_follow', ['is_active'])

        # Removing index on 'Waaave', fields ['is_active']
        db.delete_index(u'share_waaave', ['is_active'])
