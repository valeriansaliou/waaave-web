...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.language'
        db.alter_column(u'book_item', 'language', self.gf('_commons.fields.LanguageField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Item.language'
        db.alter_column(u'book_item', 'language', self.gf('_commons.fields.LanguageField')(max_length=5))
