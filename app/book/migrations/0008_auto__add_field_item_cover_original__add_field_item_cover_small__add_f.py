...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.cover_original'
        db.add_column(u'book_item', 'cover_original',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)

        # Adding field 'Item.cover_small'
        db.add_column(u'book_item', 'cover_small',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)

        # Adding field 'Item.cover_large'
        db.add_column(u'book_item', 'cover_large',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.cover_original'
        db.delete_column(u'book_item', 'cover_original')

        # Deleting field 'Item.cover_small'
        db.delete_column(u'book_item', 'cover_small')

        # Deleting field 'Item.cover_large'
        db.delete_column(u'book_item', 'cover_large')
