...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Author.book'
        db.alter_column(u'book_author', 'book_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['book.Item'], unique=True))
        # Adding unique constraint on 'Author', fields ['book']
        db.create_unique(u'book_author', ['book_id'])


        # Changing field 'Author.person'
        db.alter_column(u'book_author', 'person_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['book.Person'], unique=True))
        # Adding unique constraint on 'Author', fields ['person']
        db.create_unique(u'book_author', ['person_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Author', fields ['person']
        db.delete_unique(u'book_author', ['person_id'])

        # Removing unique constraint on 'Author', fields ['book']
        db.delete_unique(u'book_author', ['book_id'])


        # Changing field 'Author.book'
        db.alter_column(u'book_author', 'book_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['book.Item']))

        # Changing field 'Author.person'
        db.alter_column(u'book_author', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['book.Person']))
