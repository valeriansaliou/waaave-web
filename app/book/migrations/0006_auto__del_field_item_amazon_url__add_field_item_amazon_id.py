...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.amazon_url'
        db.delete_column(u'book_item', 'amazon_url')

        # Adding field 'Item.amazon_id'
        db.add_column(u'book_item', 'amazon_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.amazon_url'
        db.add_column(u'book_item', 'amazon_url',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=200),
                      keep_default=False)

        # Deleting field 'Item.amazon_id'
        db.delete_column(u'book_item', 'amazon_id')
