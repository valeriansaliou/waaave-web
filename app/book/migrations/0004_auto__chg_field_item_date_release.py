...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.date_release'
        db.alter_column(u'book_item', 'date_release', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 1, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Item.date_release'
        db.alter_column(u'book_item', 'date_release', self.gf('django.db.models.fields.DateTimeField')(null=True))
