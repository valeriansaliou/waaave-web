...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Record.date_add'
        db.delete_column(u'relevance_record', 'date_add')

        # Adding field 'Record.date'
        db.add_column(u'relevance_record', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 6, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Record.date_add'
        db.add_column(u'relevance_record', 'date_add',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 6, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Record.date'
        db.delete_column(u'relevance_record', 'date')
