...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'List.color'
        db.add_column(u'tag_list', 'color',
                      self.gf('_commons.fields.ColorField')(default='', max_length=6, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'List.color'
        db.delete_column(u'tag_list', 'color')
    ...
    models = {
        ...
        u'tag.list': {
            ...
            'color': ('_commons.fields.ColorField', [], {'max_length': '6', 'blank': 'True'}),
