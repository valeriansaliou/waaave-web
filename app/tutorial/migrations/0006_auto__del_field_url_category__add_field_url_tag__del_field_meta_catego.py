...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename field 'Url.category' to 'Url.tag'
        db.rename_column(u'tutorial_url', 'category', 'tag')


    def backwards(self, orm):
        # Rename field 'Url.tag' to 'Url.category'
        db.rename_column(u'tutorial_url', 'tag', 'category')
