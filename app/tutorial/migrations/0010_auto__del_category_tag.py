...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'tutorial_meta', 'category')


    def backwards(self, orm):
        # Adding field 'Tag.category'
        db.add_column(u'tutorial_category',
    ...
    models = {
        ...
        u'tutorial.tag': {
            ...
            'date_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'tutorial_tag_list'", 'to': u"orm['tag.List']"}),
            'tutorial': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tutorial_tags'", 'to': u"orm['tutorial.Meta']"})
        },
        u'tutorial.url': {
