...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.github'
        db.delete_column(u'account_profile', 'github')

        # Deleting field 'Profile.facebook'
        db.delete_column(u'account_profile', 'facebook')

        # Deleting field 'Profile.twitter'
        db.delete_column(u'account_profile', 'twitter')


    def backwards(self, orm):
        # Adding field 'Profile.github'
        db.add_column(u'account_profile', 'github',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)

        # Adding field 'Profile.facebook'
        db.add_column(u'account_profile', 'facebook',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)

        # Adding field 'Profile.twitter'
        db.add_column(u'account_profile', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)
