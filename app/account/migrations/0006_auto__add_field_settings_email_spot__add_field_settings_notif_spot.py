...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.email_spot'
        db.add_column(u'account_settings', 'email_spot',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Settings.notif_spot'
        db.add_column(u'account_settings', 'notif_spot',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settings.email_spot'
        db.delete_column(u'account_settings', 'email_spot')

        # Deleting field 'Settings.notif_spot'
        db.delete_column(u'account_settings', 'notif_spot')
    ...
    models = {
        ...
        u'account.settings': {
            ...
            'email_spot': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'notif_spot': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
