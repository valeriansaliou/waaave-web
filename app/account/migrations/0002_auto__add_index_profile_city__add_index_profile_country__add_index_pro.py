...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Profile', fields ['city']
        db.create_index(u'account_profile', ['city'])

        # Adding index on 'Profile', fields ['country']
        db.create_index(u'account_profile', ['country'])

        # Adding index on 'Profile', fields ['company']
        db.create_index(u'account_profile', ['company'])

        # Adding index on 'Profile', fields ['specialty']
        db.create_index(u'account_profile', ['specialty'])


    def backwards(self, orm):
        # Removing index on 'Profile', fields ['specialty']
        db.delete_index(u'account_profile', ['specialty'])

        # Removing index on 'Profile', fields ['company']
        db.delete_index(u'account_profile', ['company'])

        # Removing index on 'Profile', fields ['country']
        db.delete_index(u'account_profile', ['country'])

        # Removing index on 'Profile', fields ['city']
        db.delete_index(u'account_profile', ['city'])
