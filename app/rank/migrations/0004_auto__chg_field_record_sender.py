...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Record.sender'
        db.alter_column(u'rank_record', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Record.sender'
        db.alter_column(u'rank_record', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        u'rank.record': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'rank_record_sender'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'sender_rank': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'}),
            'sender_rank_impact': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '3', 'decimal_places': '2'})
        }
    }
