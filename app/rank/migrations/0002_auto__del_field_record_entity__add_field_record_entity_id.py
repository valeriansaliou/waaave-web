...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Record.entity'
        db.delete_column(u'rank_record', 'entity_id')

        # Adding field 'Record.entity_id'
        db.add_column(u'rank_record', 'entity_id',
                      self.gf('_commons.fields.IdField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Record.entity'
        db.add_column(u'rank_record', 'entity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='rank_record_entity', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Record.entity_id'
        db.delete_column(u'rank_record', 'entity_id')
    ...
    models = {
        ...
        u'rank.record': {
            ...
            'entity_id': ('_commons.fields.IdField', [], {}),
