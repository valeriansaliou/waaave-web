...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pool.in_reply_to'
        db.add_column(u'comment_pool', 'in_reply_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comment_active_reply', null=True, to=orm['comment.Pool']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pool.in_reply_to'
        db.delete_column(u'comment_pool', 'in_reply_to_id')
    ...
    models = {
        ...
        u'comment.pool': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_reply_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comment_active_reply'", 'null': 'True', 'to': u"orm['comment.Pool']"}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['_index.Ids']"})
        },
        u'comment.relevance': {
