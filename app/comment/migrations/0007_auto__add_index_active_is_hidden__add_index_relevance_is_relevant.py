...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Active', fields ['is_hidden']
        db.create_index(u'comment_active', ['is_hidden'])

        # Adding index on 'Relevance', fields ['is_relevant']
        db.create_index(u'comment_relevance', ['is_relevant'])


    def backwards(self, orm):
        # Removing index on 'Relevance', fields ['is_relevant']
        db.delete_index(u'comment_relevance', ['is_relevant'])

        # Removing index on 'Active', fields ['is_hidden']
        db.delete_index(u'comment_active', ['is_hidden'])
