...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Active.hidden'
        db.delete_column(u'comment_active', 'hidden')

        # Adding field 'Active.is_hidden'
        db.add_column(u'comment_active', 'is_hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Active.hidden'
        db.add_column(u'comment_active', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Active.is_hidden'
        db.delete_column(u'comment_active', 'is_hidden')
