...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pool.in_reply_to'
        db.alter_column(u'comment_pool', 'in_reply_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['comment.Active']))

    def backwards(self, orm):

        # Changing field 'Pool.in_reply_to'
        db.alter_column(u'comment_pool', 'in_reply_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['comment.Pool']))
